...
function svgFor(state, mode) {
  ...
  if (visual.kind === 'column-mode') {
    return `<svg viewBox="0 0 480 300" role="img" aria-label="Idealized column instability mode schematic"><text x="22" y="28" class="fp-title">${visual.title}</text><line x1="160" y1="65" x2="160" y2="255" class="fp-reference"/><path d="${visual.path}" class="fp-member"/><rect x="126" y="255" width="68" height="12" class="fp-support"/><polygon points="145,65 175,65 160,48" class="fp-support"/><text x="220" y="100" class="fp-text">straight reference axis</text><text x="220" y="128" class="fp-text">schematic instability mode</text><text x="22" y="286" class="fp-warning">${visual.disclaimer}</text></svg>`;
  }
