...
function woodResearchMaterial({
  id,
  name,
  densityKgM3,
  elasticModulusMPa,
  proportionalLimitMPa,
  ultimateBendingMPa,
  compressionParallelMPa,
  showInPrimaryUi = false
}) {
  return {
    id,
    ...
    maxLengthM: 3.6,
    showInPrimaryUi,
    archiveCategory: showInPrimaryUi ? null : 'supplementary research species',
    elasticModulusMPa,
    densityKgM3,
...
export const PH_WOOD_RESEARCH_MATERIALS = [
  ...
  woodResearchMaterial({
    id: 'wood-mahogany-ph-2025',
    name: 'Mahogany (Swietenia macrophylla)',
    densityKgM3: 520,
    elasticModulusMPa: 7_110,
    proportionalLimitMPa: 29.69,
    ultimateBendingMPa: 66.96,
    compressionParallelMPa: 35.62,
