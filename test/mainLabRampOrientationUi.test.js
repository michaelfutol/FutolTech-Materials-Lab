...
test('main Materials Lab loads the governing-limit timeline, angle catalog geometry, and four-way orientation modules', () => {
  assert.match(indexHtml, /Build 2026-08-18\.SL3/);
  ...
  assert.match(indexHtml, /mainLabFailureRamp\.js\?v=20260818-governing1/);
...
test('Run to Governing Limit exposes an event timeline with pause, step and stop controls', () => {
  ...
  assert.match(rampUi, /SERVICEABILITY/);
