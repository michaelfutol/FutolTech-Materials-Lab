...
try{
  ...
  console.log('C-purlin polish Chromium QA passed: static sloped-rafter attachment view is non-animated/no-support-symbol, mirrored slope controls share one state, longitudinal purlin span stays horizontal between perpendicular rafters, load arrow follows deflection, and loading continues through all first-yield thresholds.');
