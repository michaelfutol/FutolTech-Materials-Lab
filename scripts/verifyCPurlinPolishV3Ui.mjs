...
try{
  ...
  if(!(ready.resultsWidth>ready.shellWidth*.9)||ready.resultsGridStart!=='1'||ready.resultsGridEnd!=='-1')throw new Error(`Results do not span the full comparison grid: ${JSON.stringify(ready)}`);
